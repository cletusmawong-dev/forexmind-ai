      ...
      return (
        <div className="relative flex min-h-screen items-center justify-center px-6">
          ...
          <div className="glass w-full max-w-[380px] p-7 text-center animate-fadeUp">
            ...
            <pre className="mt-4 max-h-24 overflow-auto rounded-2xl border border-[rgba(122,92,34,0.07)] bg-[rgba(122,92,34,0.045)] p-3 text-left text-[10px] leading-relaxed text-txt-faint">
